...
export const Feature1 = ({
  ...
  return (
    <section className="pb-4 flex items-center justify-center relative overflow-hidden min-h-screen"> {/* pt-0 for higher centering; justify-center for not fully left-aligned */}
      {videoSrc && (
        <video
      ...
      <div className="container px-12 relative z-10"> {/* Increased px-8 to px-16 for more left distance */}
        <div className="flex items-center"> {/* Changed back to items-center for vertical alignment */}
          <div className="flex flex-col items-start text-left"> {/* Removed justify-center; items-start for left content; vertical centering handled by parent flex */}
            {image && (
            ...
            <div className="flex w-full flex-col items-start justify-start gap-6 sm:flex-row"> {/* items-start for left-aligned buttons */}
