        ...
        <div className="bg-white shadow-xl rounded-lg p-8 md:p-10">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              />
              {errors.yourTitle && (
                <p className="mt-1 text-sm text-red-600">{errors.yourTitle}</p>
              )}
            </div>
            ...
            <div>
              ...
              {errors.referral && (
                <p className="mt-1 text-sm text-red-600">{errors.referral}</p>
              )}
            </div>
            ...
            <div className="text-xs text-gray-500 italic bg-gray-50 p-4 rounded-md border border-gray-200">
              <p>
                ...
                your personal information to manage your account and deliver the
                products or services you’ve requested from us.
              </p>
              <p className="mt-2">
                By reaching out, you explicitly consent to receive
                communications related to your inquiry and allow us to store and
                process your personal data. You may unsubscribe from these
